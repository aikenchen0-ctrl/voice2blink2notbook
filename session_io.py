        ...
        self._markers_writer.writerow(
            {
                ...
                "blink_detector_event_id": snapshot.get("blink_detector_event_id", ""),
                "blink_detector_is_event": snapshot.get("blink_detector_is_event", ""),
                "blink_detector_method": snapshot.get("blink_detector_method", ""),
                "blink_peak_event_id": snapshot.get("blink_peak_event_id", ""),
                "blink_peak_is_event": snapshot.get("blink_peak_is_event", ""),
                "blink_peak_score": _format_optional_float(snapshot.get("blink_peak_score")),
                "blink_peak_threshold": _format_optional_float(snapshot.get("blink_peak_threshold")),
                "blink_peak_ratio": _format_optional_float(snapshot.get("blink_peak_ratio")),
